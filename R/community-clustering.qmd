...
2.  Join centers to their overlapping neighbors
...
Step 1 is already done and stored in the data. Step 3 is technically done before
2 since it means those sites can be ignored afterwards.
